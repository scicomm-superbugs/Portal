...
export default function SciCommDownload() {
  ...
  const platforms = [
    { 
      id: 'android', 
      name: 'Android (.apk)', 
      icon: <img src="https://www.vectorlogo.zone/logos/android/android-icon.svg" alt="Android" style={{ height: '32px', width: '32px', objectFit: 'contain' }} />, 
      color: '#3ddc84', 
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'white', color: '#0f172a', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <nav style={{ padding: '24px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #f1f5f9' }}>
        ...
        <div style={{ fontSize: '14px', color: '#94a3b8', fontWeight: 500 }}>v5.0.1 (BETA EARLY ACCESS)</div>
      </nav>
